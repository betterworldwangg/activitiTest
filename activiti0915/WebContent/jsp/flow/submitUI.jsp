...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="<%=path %>/style/images/title_arrow.gif"/> 提交申请
        </div>
...
<!--显示表单内容-->
<div id=MainArea>
    <form action="<%=path %>/flowAction_submit" method="post" enctype="multipart/form-data">
    	<s:hidden name="templateId"></s:hidden>
        <div class="ItemBlock_Title1"><!-- 信息说明 --><div class="ItemBlock_Title1">
        	<img border="0" width="4" height="7" src="<%=path %>/style/blue/images/item_point.gif" /> 下载文档模板 </div> 
        </div>
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
					<tr>
						<td><a href="templateAction_download?id=${templateId }" style="text-decoration: underline">[点击下载文档模板文件]</a></td>
					</tr>
                </table>
            </div>
        </div>
        ...
        <div id="InputDetailBar">
            <input type="image" src="<%=path %>/style/blue/images/button/submit.PNG"/>
