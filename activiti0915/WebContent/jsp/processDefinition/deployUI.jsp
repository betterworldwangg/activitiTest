...
<head>
    ...
    <script language="javascript" src="<%=path %>/script/DemoData.js" charset="utf-8"></script>
	<script language="javascript" src="<%=path %>/script/DataShowManager.js" charset="utf-8"></script>
...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="<%=path %>/style/images/title_arrow.gif"/> 部署流程定义
        </div>
...
<!--显示表单内容-->
<div id=MainArea>
    <form action="processDefinitionAction_deploy" method="post" enctype="multipart/form-data">
        <div class="ItemBlock_Title1"><!-- 信息说明<DIV CLASS="ItemBlock_Title1">
        	<IMG BORDER="0" WIDTH="4" HEIGHT="7" SRC="<%=path %>/style/blue/images/item_point.gif" /> 部署流程定义 </DIV>  -->
        </div>
