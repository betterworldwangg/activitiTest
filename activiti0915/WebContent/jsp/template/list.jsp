...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="<%=path %>/style/images/title_arrow.gif"/> 模板管理
        </div>
...
<div id="MainArea">
        ...
        <tbody id="TableData" class="dataContainer" datakey="documentTemplateList">
			<s:iterator value="list">
				<tr class="TableDetail1 template">
						...
						<td>${key}&nbsp;</td>
						<td><a onclick="return window.confirm('确定删除当前模板吗？')" href="templateAction_deleteById?id=${id }">删除</a>
							<a href="templateAction_updateUI?id=${id }">修改</a>
							<a href="templateAction_download?id=${id }">下载</a>
						</td>
				</tr>
			</s:iterator>
        </tbody>
    ...
    <div id="TableTail">
        <div id="TableTail_inside">
			<a href="templateAction_saveUI"><img src="<%=path %>/style/blue/images/button/addNew.PNG" /></a>
        </div>
    </div>
