...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="<%=path %>/style/images/title_arrow.gif"/> 审批处理
        </div>
...
<!--显示表单内容-->
<div id=MainArea>
    <form action="flowAction_approve" method="post">
    	<s:hidden name="applicationId"></s:hidden>
    	<s:hidden name="taskId"></s:hidden>
    	<input type="hidden" id="approval" name="approval" value="true">
		<div class="ItemBlock_Title1"><!-- 信息说明 --><div class="ItemBlock_Title1">
        	<img border="0" width="4" height="7" src="<%=path %>/style/blue/images/item_point.gif" /> 申请信息 </div> 
        </div>
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
					<tr>
						<td><a href="flowAction_download?applicationId=${applicationId }" style="text-decoration: underline">[点击下载申请的文档]</a></td>
					</tr>
                </table>
            </div>
        </div>
		...
		<div class="ItemBlock_Title1"><!-- 信息说明 --><div class="ItemBlock_Title1">
        	<img border="0" width="4" height="7" src="<%=path %>/style/blue/images/item_point.gif" /> 审批信息 </div> 
        </div>
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
        ...
        <div id="InputDetailBar" style="float:none">
			...
			<input type="image" src="<%=path %>/style/blue/images/button/agree.png"/>
			<input type="image" onclick="document.getElementById('approval').value='false'" src="<%=path %>/style/blue/images/button/disagree.png"/>
            <!-- <img src="<%=path %>/style/blue/images/button/sendBack.png" onClick="selectToNode();" /> -->
